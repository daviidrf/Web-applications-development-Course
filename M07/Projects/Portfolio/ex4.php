            ...
            <div class="form-col-md6">
                ...
                <div class="form check">
                    ...
                    <div class="form-check-inline">
                        <input type="radio" class="form-check-inpu" name="sexo" checked value="Hombre" /> Hombre
                        <!--me lo invento para ver todos los casos-->
                ...
                <div class="form check ">
                    ...
                    <div class="form-check-inline">
                        <input type="checkbox" class="form-check-input" name="hobbies[]" value="Monta&ntilde;a" /> Monta&ntilde;a
                        <!--atencion con los corchetes de hobbies-->
